...
name = "freqwise_medfilt_localMAD_ignorezero_5MAD" # string to identify plots saved with these settings
...
MAD = np.ma.median(np.abs(np.ma.masked_where(corrected == 0, corrected)), axis=0)
